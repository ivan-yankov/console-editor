...
public class ConsoleTableViewerTest {
    ...
    public void show() {
        List<TestData> testData = List.of(
                ...
                new TestData("test.csv", "on-up", append(fillTab(5), "exit"), List.of("up", "exit")),
                new TestData("test.csv", "on-down", List.of("exit"), List.of("down", "exit")),
                new TestData("test.csv", "on-first-col", append(fillTab(4), "exit"), List.of("first-col", "exit")),
                ...
                new TestData("multi-page.csv", "on-first-row", append(fillTab(220), "page-down", "page-down", "exit"), List.of("first-row", "exit")),
